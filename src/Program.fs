...
let phrases = [
    ...
    "(307209526174810112)", "да что у меня с осу"
    "(307209526174810112)", "только дебил 5* поставит"
    "(307209526174810112)", "бля стримы слишком лоубпмные я их пережимаю"
    "(307209526174810112)", "я тебя щас догоню и по аккураси выебу"
    "(307209526174810112)", "джампы ебаные, а стримы вообще изи"
    "(307209526174810112)", "а ну я комбо набрал поэтому обогнал"
    "(307209526174810112)", "да почему у меня клавиатура двигается? заебала!"
    "(307209526174810112)", "как руку забить чтобы 300 бпм жать?"
    "(405479716687183873)", "Кто не разу не банился тот не уважаемый"
    "(307209526174810112)", " У меня рука заебалась уже"
    "(820388912312221706)", "Так внимание человек с RSI на правой руке ебашит джампы"
    "(820388912312221706)", "(Сыграл джампо карту 7 звезд в 93%) даже чувство что в аккураси получается"
    "(820388912312221706)", "Зайдите на демку кто-нибудь хочу чтобы сказали какой я ахуенный"
    "(820388912312221706)", "Ой блять как рука заболела ебучий RSI"
    "(820388912312221706)", "Блять как на этом жать ебучий вутинг и кстати вутинг не импрувит"
    "(477105442531573760)", "Как играть фул скрин стримы"
]
...
let nicknames = [
    ...
    "473174801696161822", "osu_0pp"
    "341660045152354305", "249 pp uznik"
    "489065309819502592", "научите жать"
    "489065309819502592", "научите фингерконтролю"
    "795959175967801355", "а можно не чоукать"
]
